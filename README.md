...
A python library to parse TSV files as produced by the [webanno Software](https://github.com/webanno/webanno) and as described [in their documentation](https://webanno.github.io/webanno/releases/3.6.11/docs/user-guide.html#sect_webannotsv).
